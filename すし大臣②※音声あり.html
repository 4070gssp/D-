    ...
    <div class="prize-list">
      ...
      <div class="prize-item prize-item-1">
        ...
        <div class="prize-info">
          ...
          <span class="prize-name-text">マグロ鮨 揃い</span>
          <span class="prize-desc-text">20%引きクーポン</span>
        </div>
      </div>
      ...
      <div class="prize-item prize-item-2">
        ...
        <div class="prize-info">
          ...
          <span class="prize-name-text">サーモン寿司 揃い</span>
          <span class="prize-desc-text">10%引きクーポン</span>
        </div>
      </div>
      ...
      <div class="prize-item prize-item-3">
        ...
        <div class="prize-info">
          ...
          <span class="prize-name-text">玉子寿司 揃い</span>
          <span class="prize-desc-text">5%引きクーポン</span>
        </div>
      </div>
      ...
      <div class="prize-item prize-item-sub">
        ...
        <div class="prize-info">
          ...
          <span class="prize-name-text">ワンドリンク無料</span>
...
(function() {
  ...
  // タブ切り替え（count: 集計2タブ / prob: 確率設定タブ）
  ...
  // 管理画面を開く隠しトリガー: タイトル部分を5回連続タップ（2秒以内）
